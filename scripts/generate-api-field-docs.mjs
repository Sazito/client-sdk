...
const PAGE_TYPE_MAP = {
  ...
  'docs/content/docs/api-reference/feedbacks.mdx': [
    'src/api/feedbacks.ts:FeedbackSeedItem',
    'src/api/feedbacks.ts:FeedbackSeed',
    'src/api/feedbacks.ts:CreateOrderRatingInput',
    'src/api/feedbacks.ts:CommentResponse',
    'src/api/feedbacks.ts:ProductReviewRequest',
    'src/api/feedbacks.ts:ProductReviewDraft',
    'src/api/feedbacks.ts:SubmitOrderFeedbackInput',
    'src/api/feedbacks.ts:SubmitOrderFeedbackResult',
    'src/api/feedbacks.ts:ProductStatistics',
    'src/api/feedbacks.ts:ProductReview',
    'src/api/feedbacks.ts:ProductReviewsFilters',
    'src/api/feedbacks.ts:ProductReviewsResponse',
    'src/api/feedbacks.ts:ReviewAttachmentInput',
    'src/api/feedbacks.ts:ReviewUploadedImage',
    'src/api/feedbacks.ts:ReviewImageUploadResponse',
  ],
