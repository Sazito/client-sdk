...
Import client configuration, API module, request, and response types from the
package root. See [TypeScript types](/docs/api-reference/types).
...
| `paymentsBasePath` | `string` | Optional | Override the payment base path used by the SDK. |
...
| `paymentsBasePath` | `string` | Optional |
